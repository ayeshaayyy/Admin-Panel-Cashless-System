      ...
      .get().then(querySnapshot => {
          ...
          querySnapshot.forEach(function(doc) {
              record.push({
                  ...
                  Vendor_Name: doc.data().vendor,
                  CreatedAt: moment(doc.data().createdAt.toDate()).format("lll"),
              });
          });
      ...
      return (
        <main id="content" className="p-5">
          ...
          <MDBCardBody id="breadcrumb" className="d-flex align-items-center justify-content-between">
              ...
              <div class="panel-body" style={{ textColor: "black"}}>
          ...
          <BootstrapTable data={this.state.record} bordered={ true } pagination={ true } options={ options } striped hover condensed exportCSV data={ this.state.record }
             search 
          >
  <TableHeaderColumn dataField='Name' isKey={ true } dataSort={ true } filter={ { type: 'TextFilter', delay: 1000 } }>Student Name</TableHeaderColumn>
  <TableHeaderColumn  dataField='Description' filter={ { type: 'TextFilter', delay: 1000 } }>Description</TableHeaderColumn>
          <TableHeaderColumn dataField='Expense' dataSort={ true }filter={ { type: 'TextFilter', delay: 1000 } }>Expense</TableHeaderColumn>
          <TableHeaderColumn dataField='Vendor_Name' filter={ { type: 'TextFilter'}}formatExtraData={ qualityType }>Vendor Name</TableHeaderColumn>
          <TableHeaderColumn dataField='CreatedAt' filter={ { type: 'DateFilter' } }>Created At</TableHeaderColumn>
